...
const Home = () => {
    return (
        <section
            id='hero'
            className='flex items-center justify-center min-h-screen px-8 py-4 bg-orange/10 md:flex-row'
        >
            <div className='flex flex-col items-center justify-between w-full max-w-5xl gap-5 mx-auto md:flex-row '>
              ...
              that meets your needs
                ...
                <figure>
                    <LazyImage src={heroImage} alt='ai display of donuts' className='object-cover w-full ' />
                </figure>
            </div>
        </section>
    );
